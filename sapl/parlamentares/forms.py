...
class VincularParlamentarForm(forms.Form):
    ...
    def clean(self):
        ...
        inicio_legislatura = cleaned_data['legislatura'].data_inicio

        if parlamentar.mandato_set.filter(data_inicio_mandato=inicio_legislatura):
        ...
        if cleaned_data['data_expedicao_diploma'] and inicio_legislatura <= cleaned_data['data_expedicao_diploma']:
